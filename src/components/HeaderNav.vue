...
.menu-toggle.menu-toggle.is-active .hamburger > span {
    transform: (45deg);
}
.menu-toggle.menu-toggle.is-active .hamburger > span:before {
    top: 0;
    transform: (0deg);
}
.menu-toggle.menu-toggle.is-active .hamburger > span:after {
    top: 0;
    transform: (90deg);
}
